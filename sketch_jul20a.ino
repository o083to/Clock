...
#define LONG_CLICK_MIN_DURATION 700
// RGB LED
#define RED_PIN 9
#define BLUE_PIN 10
#define GREEN_PIN 11
...
byte checkButton(byte buttonPin, boolean *buttonWasDown, unsigned long *buttonDownTime) {
...
void updateTimeLEDs() {
  ...
  for (byte i = 0; i < HOUR_LEDS_COUNT - 2; i++, h /= 2) {
